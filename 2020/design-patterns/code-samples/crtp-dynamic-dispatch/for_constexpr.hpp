 ...
 */
template <size_t Index, size_t Upper> struct for_symm_upper {};
...
for_constexpr_impl(F &&f, std::index_sequence<Is...> /*meta*/,
                   IntegralConstants &&... v) {
...
ALWAYS_INLINE constexpr void
for_constexpr_impl(F &&f, for_bounds<BoundsNextLower, BoundsNextUpper> /*meta*/,
